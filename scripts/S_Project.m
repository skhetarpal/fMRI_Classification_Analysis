...
if debug
    ...
    %session(1).name = 'fMRI_baby4_141011';
    session(1).name = 'fMRI_baby4_141109';
    %session(3).name = 'fMRI_baby4_141123';
    %session(4).name = 'fMRI_baby4_141224';
    session(2).name = 'fMRI_baby4_150222';
    %session(6).name = 'fMRI_baby4_150524';
    %session(7).name = 'fMRI_baby4_150705';
